            ...
            child: Table(
              ...
              children: [
                ...
                TableRow(children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('30.8 - 37.6',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
                ]),
                ...
                TableRow(children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('32.6 - 39.9',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
                ]),
                TableRow(children: [
                  Padding(
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('34.9 - 42.6',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
                ]),
                TableRow(children: [
                  Padding(
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('36.4 - 44.9',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text("39 - 47.6",style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('43.1 - 52.6',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('44.9 - 54.9 ',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('57.2 - 57.6',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
                ]),TableRow(children: [
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('49 - 59.9',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('51.2 - 62.6',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
                ]),TableRow(children: [
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('53 - 64.8',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('55.3 - 67.6',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
                ...
                TableRow(children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('57.1 - 69.8',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500))),
                    ),
                  ),
                ...
                TableRow(children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('59.4 - 72.6',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
                ]),TableRow(children: [
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('61.2 - 74.8',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Container( child: Text('63.5 - 77.5',style: GoogleFonts.aldrich(fontSize: 22.0, color: Colors.black, fontWeight: FontWeight.w500)))),
                  ),
